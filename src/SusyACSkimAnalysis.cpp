  ...
  if ( !elecHandle.isValid() ) 
	...
	for (int k=0; k<mTreeNtruthl; k++) {
      ...
      */
      ...
      mTreeEleTrkIsoDep[countele]  = -1.;
      mTreeEleECalIsoDep[countele] = -1.;
      mTreeEleHCalIsoDep[countele] = -1.;
